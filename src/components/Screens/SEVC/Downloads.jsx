                                    ...
                                    <div className='one'>
                                        ...
                                        <div className='download-desc'>
                                            ...
                                            <div className='download-descx'>
                                                SEVC-2024 EVENT INFORMATION DOCUMENT
                                                <a style={{ display: "none" }} ref={downloadref2} download href={require("../../../assets/Downloads/SEVC 2024_EVENT INFORMATION DOCUMENT FINAL.pdf")}>download</a>
                                            </div>
                                        </div>
                                    </div>
